...
class GoogleSheetsService:
    ...
    def __init__(self, credentials_json: Optional[str] = None, spreadsheet_id: Optional[str] = None):
        ...
        if not self.spreadsheet_id:
            # If no spreadsheet ID is provided, operate in demo mode
            logger.warning("No Spreadsheet ID provided. Running in demo mode with sample data.")
            self.demo_mode = True
            self.service = None
        else:
    ...
    def fetch_sheet_data(self, sheet_range: str = "A1:G100") -> List[List[Any]]:
        ...
        """
        if self.demo_mode:
            # Return sample data for demo purposes in new format
            return [
                ['Vendedor', 'Senha', 'Status'],
                ['Senhas - Supervisor', '1234-78956', ''],
                ['Senhas - Vendedor da Equipe Especial', '1234-78957', ''],
                ['Senhas - Gerente', '1234-78940', ''],
                ['Senhas - Vendedor Medicamento', '1234-78960', ''],
                ['Senhas - Vendedor Alimento', '1234-78990', '']
            ]
